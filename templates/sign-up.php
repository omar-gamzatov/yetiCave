...
<div class="page-wrapper">
  ...
  <main>
    ...
    <form class="form container form--invalid" action="./account-add.php" method="post" autocomplete="off"> <!-- form
    --invalid -->
      ...
      <div class="form__item"> <!-- form__item--invalid -->
        ...
        <?php if($_GET['email_err'] == 'incorrect_email'): ?>
          <label class="form__error">Некорректно введен E-mail</label>
        <?php endif; ?>
      </div>
